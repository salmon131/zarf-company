...
export const metadata: Metadata = {
  ...
  title: {
    default: "CafeTang - 카공 & 북카페",
    template: "%s | CafeTang",
  },
  description: "편하게 쉬고, 작업하고, 공부할 수 있는 서울 강동구 카공 & 북카페 CafeTang. 스터디룸 대여 및 대관 문의 가능.",
  keywords: ["CafeTang", "카페탱", "카공카페", "북카페", "스터디룸", "강동구 카페", "암사동 카페", "회의실 대여"],
  ...
  openGraph: {
    ...
    siteName: "CafeTang - 카공 & 북카페",
    title: "CafeTang - 카공 & 북카페",
    description: "편하게 쉬고, 작업하고, 공부할 수 있는 서울 강동구 카공 & 북카페 CafeTang. 스터디룸 대여 및 대관 문의 가능.",
    images: [
      {
